...
| 6 Read, library, editor, import | `2026-09-03-phase-6-cards.md` (written) | 3.5, 7.3, 7.7 | Read cards, cards library, dump editor with hex viewer, reference-app JSON import, card picker API | integration test: scan a fake card, save, edit, import fixture |
