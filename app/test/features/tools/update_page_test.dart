...
void main() {
  testWidgetsApp('the placeholder names the phase and the BLE notice', (
    tester,
  ) async {
  ...
  testWidgetsApp('the BLE notice shows while dfuOverBleEnabled is false', (
    tester,
  ) async {
  ...
  testWidgetsApp('the BLE notice is hidden once dfuOverBleEnabled is true', (
    tester,
  ) async {
    await tester.pumpWidget(
      ProviderScope(
  ...
  testWidgetsApp(
    'recovering from the connect screen carries the transport id',
    (tester) async {
